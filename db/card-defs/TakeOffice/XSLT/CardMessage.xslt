...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				<span class="header2">Message</span>
				<table border="0" width="100%">
					...
					<tr>
						<td class="fieldheader" width="25%">Subject:</td>
						<td colspan="3"><xsl:value-of select="//CardMessage[1]/MainInfo/@Subject"/></td>
					</tr>
					<tr>
						<td colspan="4" class="fieldheader">Body:</td>
					</tr>
					<tr>
						<td colspan="4">
							<xsl:call-template name="replace">
					...
					<tr>
						<td class="fieldheader" width="25%">Linked card:</td>
						<td colspan="3"><xsl:value-of select="//CardMessage[1]/MainInfo/@Description"/></td>
					</tr>
					</xsl:if>
				</table>
				<p class="smalltext">
				In order to change the printing template, edit Print Template for the Message card type or create a new one based on this template.
