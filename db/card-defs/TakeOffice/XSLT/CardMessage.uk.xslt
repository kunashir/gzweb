...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				<span class="header2">Повідомлення</span>
				<table border="0" width="100%">
					...
					<tr>
						<td class="fieldheader" width="25%">Заголовок:</td>
						<td colspan="3"><xsl:value-of select="//CardMessage[1]/MainInfo/@Subject"/></td>
					</tr>
					<tr>
						<td colspan="4" class="fieldheader">Повідомлення:</td>
					</tr>
					<tr>
						<td colspan="4">
							<xsl:call-template name="replace">
					...
					<tr>
						<td class="fieldheader" width="25%">Пов'язана картка:</td>
						<td colspan="3"><xsl:value-of select="//CardMessage[1]/MainInfo/@Description"/></td>
					</tr>
					</xsl:if>
				</table>
				<p class="smalltext">
				Для того щоб змінити вигляд даного шаблону, Ви можете відредагувати "Стандартний шаблон друку" для картки "Повідомлення" або створити новий шаблон на основі даного. 
