		...
		<html>
			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						<td class="fieldheader" width="25%">Належність документу:</td>
					...
					<tr>
						...
						<td colspan="2"><xsl:if test="//CardArchive[1]/MainInfo/@Confidential=1">Конфиденциально</xsl:if></td>
					</tr>
					<tr>
				...
				<table border="0" width="100%">
					<tr>
						<td class="fieldheader" width="25%">Зберігати з:</td>
						<td><xsl:value-of select="translate(//CardArchive[1]/MainInfo/@KeepFrom, 'T', ' ')"/></td>
						<td class="fieldheader" width="25%">Зберігати по:</td>
						<td><xsl:value-of select="translate(//CardArchive[1]/MainInfo/@KeepTo, 'T', ' ')"/></td>
					</tr>
					<tr>
						...
						<xsl:text disable-output-escaping="yes">
							...
							&lt;table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="black" width="100%"&gt;
								&lt;tr&gt;
									...
									&lt;th class="tableheader" align="left"&gt;Коментарі&lt;/th&gt;
								&lt;/tr&gt;
						</xsl:text>
					</xsl:if>
					<tr>
				...
				<p class="smalltext">
				Для того щоб змінити вигляд даного шаблону, Ви можете Відредагувати "Стандартний шаблон друку" для картки "Архівний документ" або створити новий шаблон на основі даного. 
