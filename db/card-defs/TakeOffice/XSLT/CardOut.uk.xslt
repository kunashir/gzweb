			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						...
						<td colspan="2"><xsl:if test="//CardOut[1]/MainInfo/@Confidential=1">Конфіденційно</xsl:if></td>
					</tr>
					<tr>
				...
				<xsl:for-each select="//CardOut[1]/Recipients/RecipientsRow">
					<xsl:if test="position()=1">
						<xsl:text disable-output-escaping="yes">
							&lt;span class="header2"&gt;Отримувач&lt;/span&gt;
							&lt;table border="0" width="100%"&gt;
						</xsl:text>
					</xsl:if>
					<tr>
						...
						<td class="fieldheader" width="25%">Вхідний номер:</td>
						<td>
					...
					<tr>
						<td class="fieldheader" width="25%">Адреса:</td>
						<td colspan="3">
				...
				<xsl:for-each select="//CardOut[1]/Properties/PropertiesRow[(@Hidden=0 or not(@Hidden)) and @ParamType!=19]">
					<xsl:if test="position()=1">
						<xsl:text disable-output-escaping="yes">
							&lt;span class="header2"&gt;Властивості документа&lt;/span&gt;
							&lt;table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="black" width="100%"&gt;
								&lt;tr&gt;
				...
				<p class="smalltext">
				Для того щоб змінити вигляд даного шаблона, Ви можете відредагувати "Стандартний шаблон друку" для картки "Вихідний документ" або створити новий шаблон на основі даного. 
