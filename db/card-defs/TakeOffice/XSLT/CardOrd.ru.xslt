		...
		<html>
			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						<td class="fieldheader" width="25%">Получатели:</td>
						<td colspan="3">
				...
				<p class="smalltext">
				Для того чтобы изменить вид данного шаблона, Вы можете отредактировать "Стандартный шаблон печати" для карточки "Внутренний документ" или создать новый шаблон на основе данного. 
