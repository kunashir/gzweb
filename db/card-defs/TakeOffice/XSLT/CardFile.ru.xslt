	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<p class="smalltext">
				Для того чтобы изменить вид данного шаблона, Вы можете отредактировать "Стандартный шаблон печати" для карточки "Карточка файла" или создать новый шаблон на основе данного. 
