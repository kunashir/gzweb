		...
		<html>
			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						<td class="fieldheader" width="25%">Реєстратор:</td>
					...
					<tr>
						<td class="fieldheader" width="25%">Отримувач:</td>
						<td colspan="3">
					...
					<tr>
						<td class="fieldheader" width="25%">Стан документа:</td>
					...
					<tr>
						<td class="fieldheader" width="25%">Реквізит документа:</td>
						<td width="25%"><xsl:value-of select="//CardInc[1]/MainInfo/@DocProperty"/></td>
						<td colspan="2"><xsl:if test="//CardInc[1]/MainInfo/@Confidential=1">Конфіденційно</xsl:if></td>
					</tr>
					<tr>
				...
				<br></br>				
				<span class="header2">Дані вихідного документа</span>				 
				<table border="0" width="100%">
					<tr>
						<td class="fieldheader" width="25%">Вихідний номер:</td>
						<td><xsl:value-of select="//CardInc[1]/MainInfo/@OutgoingNumber"/></td>
					</tr>
					<tr>
						<td class="fieldheader" width="25%">Дата вихідного:</td>
						<td>
							<xsl:call-template name="convertdatetime">
					...
					<tr>
						<td class="fieldheader" width="25%">Відправник:</td>
						<td>
							<xsl:choose>
					...
					<tr>
						<td class="fieldheader" width="25%">Контактна особа:</td>
						<td>
							<xsl:choose>
					...
					<tr>
						<td class="fieldheader" width="25%">Організація:</td>
						<td><xsl:value-of select="//CardInc[1]/MainInfo/@SenderOrg"/></td>
					</tr>
					<tr>
						<td class="fieldheader" width="25%">Підрозділ:</td>
				...
				<p class="smalltext">
				Для того щоб змінити вигляд даного шаблону, Ви можете відредагувати "Стандартний шаблон друку" для картки "Вхідний документ" або створити новий шаблон на основі даного. 
