		...
		<html>
			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						<td class="fieldheader" width="25%">Принадлежность документа:</td>
				...
				<table border="0" width="100%">
					<tr>
						<td class="fieldheader" width="25%">Хранить с:</td>
						<td width="25%">
							<xsl:call-template name="convertdatetime">
								<xsl:with-param name="str" select="//CardArchive[1]/MainInfo/@KeepFrom"/>
							</xsl:call-template>
						</td>
						<td class="fieldheader" width="25%">Хранить по:</td>
						<td width="25%">
							<xsl:call-template name="convertdatetime">
				...
				<p class="smalltext">
				Для того чтобы изменить вид данного шаблона, Вы можете отредактировать "Стандартный шаблон печати" для карточки "Архивный документ" или создать новый шаблон на основе данного. 
