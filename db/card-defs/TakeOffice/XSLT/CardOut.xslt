			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						...
						<td colspan="2"><xsl:if test="//CardOut[1]/MainInfo/@Confidential=1">Confidential</xsl:if></td>
					</tr>
					<tr>
				...
				<xsl:for-each select="//CardOut[1]/Recipients/RecipientsRow">
					<xsl:if test="position()=1">
						<xsl:text disable-output-escaping="yes">
							&lt;span class="header2"&gt;Recipients&lt;/span&gt;
							&lt;table border="0" width="100%"&gt;
						</xsl:text>
					</xsl:if>
					<tr>
						...
						<td class="fieldheader" width="25%">Incoming number:</td>
						<td>
					...
					<tr>
						<td class="fieldheader" width="25%">Address:</td>
						<td colspan="3">
				...
				<p class="smalltext">
				In order to change the printing template, edit Print Template for the Outgoing Document card type or create a new one based on this template.
