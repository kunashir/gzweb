		...
		<html>
			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						<td class="fieldheader" width="25%">Approved by:</td>
						<td colspan="3">
					...
					<tr>
						...
						<td colspan="3">
							<xsl:for-each select="//CardOrd[1]/Employees/EmployeesRow[@Type=1]">
								<xsl:if test="@IsResponsible=1">
									<xsl:text disable-output-escaping="yes">&lt;span class="fieldheader"&gt;</xsl:text>
								</xsl:if>
					...
					<tr>
						...
						<td width="25%">
							<xsl:value-of select="//CardOrd[1]/MainInfo/@Control_LName"/>
							<xsl:if test="string-length(//CardOrd[1]/MainInfo/@Control_LName)!=0"> </xsl:if>
							<xsl:value-of select="//CardOrd[1]/MainInfo/@Control_FName"/>
							<xsl:if test="string-length(//CardOrd[1]/MainInfo/@Control_FName)!=0"> </xsl:if>
							<xsl:value-of select="//CardOrd[1]/MainInfo/@Control_MName"/>
						</td>
						<td class="fieldheader" width="25%">Control date:</td>
						<td width="25%">
							<xsl:call-template name="convertdatetime">
								<xsl:with-param name="str" select="//CardOrd[1]/MainInfo/@ControlDate"/>
							</xsl:call-template>
						</td>
					</tr>
					<tr>
						...
						<td colspan="2"><xsl:if test="//CardOrd[1]/MainInfo/@Confidential=1">Confidential</xsl:if></td>
					</tr>
					<tr>
				...
				<xsl:variable name="FileListID">
					<xsl:value-of select="//CardOrd[1]/MainInfo/@FilesID"/>
				</xsl:variable>
				...
				<xsl:for-each select="//CardOrd[1]/TransferLog/TransferLogRow">
					<xsl:if test="position()=1">
						<xsl:text disable-output-escaping="yes">
				...
				<p class="smalltext">
				In order to change the printing template, edit Print Template for the Internal Document card type or create a new one based on this template.
