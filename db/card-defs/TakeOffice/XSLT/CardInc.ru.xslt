			...
			<body>
				...
				<table border="0" width="100%">
					...
					<tr>
						...
						<td colspan="2"><xsl:if test="//CardInc[1]/MainInfo/@Confidential=1">Конфиденциально</xsl:if></td>
					</tr>
					<tr>
				...
				<br></br>				
				<span class="header2">Данные исходящего документа</span>				 
				<table border="0" width="100%">
					<tr>
						<td class="fieldheader" width="25%">Исходящий номер:</td>
						<td><xsl:value-of select="//CardInc[1]/MainInfo/@OutgoingNumber"/></td>
					</tr>
					<tr>
						<td class="fieldheader" width="25%">Дата иcходящего:</td>
						<td>
							<xsl:call-template name="convertdatetime">
					...
					<tr>
						<td class="fieldheader" width="25%">Контактное лицо:</td>
						<td>
							<xsl:choose>
				...
				<p class="smalltext">
				Для того чтобы изменить вид данного шаблона, Вы можете отредактировать "Стандартный шаблон печати" для карточки "Входящий документ" или создать новый шаблон на основе данного. 
