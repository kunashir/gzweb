BEGIN
	...
	SELECT DISTINCT
		   ...
		   COALESCE(
		      contractMainInfo.RegistrationNumber, 
		      memorandumMainInfo.RegistrationNumber,
		      warrantMainInfo.RegistrationNumber,
		      outDocMainInfo.RegistrationNumber,
		      directionMainInfo.RegistrationNumber,
		      orderMainInfo.RegistrationNumber,
		      incDocMainInfo.RegistrationNumber,
		      lnaMainInfo.RegistrationNumber,
		      protocolMainInfo.RegistrationNumber) as DocNumber,
