...
(
   select  [InstanceID] as [DocID]
	...
	where  [State] = '1'
	and (@actorID = DurationAssignmentTable.Performer or @actorID in (select [Coperformer] from [dbo].[dvtable_{15AE16C0-B562-4311-94DD-2E14C6542F5A}] Coperformers where Coperformers.[InstanceID] = DurationAssignmentTable.[InstanceID]))
) Data
