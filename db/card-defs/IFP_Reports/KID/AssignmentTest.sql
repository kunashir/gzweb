BEGIN
	...
	declare @table as table ([assignmentID] uniqueidentifier, [assignmentDate] datetime, [assignmentComment] ntext, [assignmentContent] ntext)
	...
	begin
		insert into @table([assignmentID], [assignmentDate], [assignmentComment], [assignmentContent])
		select [History].[RowID], [History].[Date], [History].[Comment], [AssignmentMainInfo].[Content]
	...
	select [assignmentID] as AssignmentID, [assignmentDate] as AssignmentDate, [assignmentComment] as CommentText, [assignmentContent] as ContentText
	from @table
