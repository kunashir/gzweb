...
Approvals.Approver,
Approvals.StartDate,
Approvals.ApprovingDate
FROM @docs AS Documents,
[dvtable_{2B9AB001-ABED-4D62-88AC-E7DA49ED59B5}] as Approvals
WHERE Documents.InstanceID = Approvals.InstanceID AND Approvals.Decision = 0
*/
...
Approvals.ApprovingDate
FROM @docs AS Documents,
[dvtable_{F0DC8EDD-1F37-4B6A-ABF3-BD527808B304}] as Approvals
WHERE Documents.InstanceID = Approvals.InstanceID AND Approvals.Decision = 0
...
Approvals.ApprovingDate
FROM @docs AS Documents,
[dvtable_{2E9C5799-3AE7-4164-BC9C-DE18C4CCAF71}] as Approvals
WHERE Documents.InstanceID = Approvals.InstanceID AND Approvals.Decision = 0	
...
Approvals.ApprovingDate
FROM @docs AS Documents,
[dvtable_{076F7B28-2E5D-4A9E-835C-6A8D83B82168}] as Approvals
WHERE Documents.InstanceID = Approvals.InstanceID AND Approvals.Decision = 2
...
Approvals.ApprovingDate
FROM @docs AS Documents,
[dvtable_{BF8269DB-570A-47AC-98F1-E88E40AF7661}] as Approvals
WHERE Documents.InstanceID = Approvals.InstanceID AND Approvals.Decision = 2
