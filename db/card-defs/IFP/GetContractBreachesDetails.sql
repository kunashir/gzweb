IF NOT OBJECT_ID('[dbo].[dvreport_get_data_{5A542751-ED2F-4EAC-A440-4319847AE488}]') IS NULL
	DROP PROCEDURE [dbo].[dvreport_get_data_{5A542751-ED2F-4EAC-A440-4319847AE488}]

--Delimiter
GO

CREATE PROCEDURE [dbo].[dvreport_get_data_{5A542751-ED2F-4EAC-A440-4319847AE488}]
(@currentState As bit = NULL,
@dateStart As datetime = NULL,
@dateEnd As datetime = NULL) WITH ENCRYPTION
AS
BEGIN
SELECT 
maininfo.InstanceID,
